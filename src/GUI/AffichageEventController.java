...
if (result.orElse(non) == payer) {
   ...
   FXMLLoader loader = new FXMLLoader(getClass().getResource("Map.fxml"));
    ...
    @FXML
    private void generateQR(ActionEvent event)throws WriterException, IOException,
               NotFoundException {
    ...
    @FXML
    private void readqr(ActionEvent event) {
...
if (result.orElse(non) == payer) {
 ...
 //   Validation=false;
    ...
    @FXML
    private void facturepdf(ActionEvent event) {
          Pdf pd=new Pdf();
